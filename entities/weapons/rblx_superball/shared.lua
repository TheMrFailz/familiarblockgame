SWEP.PrintName			= "Super Ball" -- This will be shown in the spawn menu, and in the weapon selection menu
...
SWEP.Primary.Sound          = "weapon_effects/shortspring2.wav"
...
SWEP.VElements = {
	["ball"] = { type = "Model", model = "models/hunter/misc/sphere375x375.mdl", bone = "ValveBiped.Bip01_R_Forearm", rel = "", pos = Vector(29.743, -7.562, -3.55), angle = Angle(0, 0, 0), size = Vector(0.294, 0.294, 0.294), color = Color(255, 255, 255, 255), surpresslightning = false, material = "skybox/plainsky_LF", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
...
function SWEP:PrimaryAttack()
    ...
    if SERVER then
    local rocket = ents.Create( "roblox_superball" )
    ...
    physics:SetVelocity((self.Owner:GetAimVector()*3000 ) + Vector(0,0,0))
