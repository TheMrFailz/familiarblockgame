SWEP.PrintName			= "Slingshot" -- This will be shown in the spawn menu, and in the weapon selection menu
...
SWEP.Primary.Sound          = "weapon_effects/rubberband2.wav"
...
SWEP.VElements = {
	["slingshot"] = { type = "Model", model = "models/roblox_weapons/slingshot/rblx_slingshot.mdl", bone = "ValveBiped.Bip01_L_Forearm", rel = "", pos = Vector(-34.774, 25.363, -6.482), angle = Angle(50.578, 0, 0), size = Vector(2.461, 2.461, 2.461), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
...
function SWEP:PrimaryAttack()
    ...
    physics:SetVelocity((self.Owner:GetAimVector()*1000 ) + Vector(0,0,300))
